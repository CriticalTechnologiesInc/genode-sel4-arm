...
elfloader/elfloader.o:
	$(VERBOSE)cp -rf $(ELFLOADER_DIR) elfloader && \
	          cd elfloader && \
	          sed -i "s/define UART_PPTR.*IMX6_UART1_PADDR/define UART_PPTR IMX6_UART2_PADDR/" src/arch-arm/plat-imx6/platform.h && \
	          $(MAKE) \
...
build_kernel: elfloader/elfloader.o
	$(VERBOSE)$(MAKE) \
	          TOOLPREFIX=$(CROSS_DEV_PREFIX) \
	          BOARD=sabre_lite ARCH=arm PLAT=imx6 CPU=cortex-a9 ARMV=armv7-a DEBUG=1 \
